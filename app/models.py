...
class HelpRequest(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    requester_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("users.id"), index=True, nullable=False)
    ...
    claimed_by: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("users.id"), nullable=True)
    ...
    library_paper_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("library_papers.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, server_default=func.now())
...
class Attachment(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    request_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("help_requests.id"), index=True, nullable=False)
    helper_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("users.id"), nullable=False)
...
class PointTransaction(Base):
    ...
    ref_request_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
